...
A premium, highly interactive frontend web application built for a gadget repair workshop and retail accessories store based in Lagos, Nigeria. The project features a custom-designed diagnosis booking intake system and a reactive inquiry bag, both integrating seamlessly with WhatsApp API templates for direct customer-to-technician communications.

## 🔗 Live Demo
Explore the production build online:  
...
### ⚙️ Gadget Repair Diagnostics Intake
...
npm run dev
```
Open **`http://localhost:5173`** in your browser to view the dev environment.

### 3. Build for production
```bash
npm run build
```
This optimizes and compiles your site into a production-ready **`dist`** folder.
...
* **Surge.sh (Cloud):** Deployed to **[freecom-technology.surge.sh](https://freecom-technology.surge.sh)** using simple CLI deployments.
