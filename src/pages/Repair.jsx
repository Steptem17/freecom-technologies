...
const Repair = () => {
  ...
  const deviceCategories = [
    ...
    { id: 'audio', name: 'Audio System', desc: 'AirPods, Bluetooth Speakers', icon: <Headphones className="h-6 w-6 text-slate-950" /> }
  ];
  ...
  const brandOptions = {
    ...
    audio: ['AirPods', 'Bluetooth Speakers', 'Others']
  };
                    ...
                    >
                      ...
                      <div className="space-y-3 pt-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          >
                            <div className="space-y-1">
                              <h5 className="font-display font-bold text-xs sm:text-sm text-slate-950">Main Headquarters Workshop</h5>
